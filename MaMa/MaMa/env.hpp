...
namespace env {
  ...
  namespace path {
    ...
    extern const char separator, delimiter;

  }

  extern const string MAMA_HOME;

  extern const class MaMaPath {

    StrVec dirs;

  public:

    typedef pair<ifstream*,ifstream*> FilePair;

    MaMaPath();

    FilePair search(const char *const, const bool = false) const;
